...
export function CategoryNav({ categories, activeTab, onTabChange }: CategoryNavProps) {
  return (
    <div className="sticky top-[4.5rem] z-30 bg-[#F2F2F7] dark:bg-background py-2 border-b border-border/30">
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Gradient fade on mobile scroll */}
        <div className="absolute right-0 top-0 bottom-0 w-12 bg-gradient-to-l from-[#F2F2F7] dark:from-background to-transparent pointer-events-none md:hidden" />
