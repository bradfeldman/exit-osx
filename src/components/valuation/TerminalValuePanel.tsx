  ...
  return (
    <Card>
      <CardHeader className="pb-3">
        <CardTitle className="text-base font-medium text-foreground">Terminal Value</CardTitle>
      </CardHeader>
      <CardContent className="space-y-5">
        {/* Method Toggle */}
        <div className="space-y-2">
          <Label className="text-sm text-foreground">Calculation Method</Label>
          ...
          <div className="space-y-4 pt-2">
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <Label htmlFor="perpetualGrowth" className="text-sm text-foreground">
        ...
        {terminalMethod === 'exit_multiple' && (
          <div className="space-y-4 pt-2">
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <Label htmlFor="exitMultiple" className="text-sm text-foreground">
            ...
            <div className="flex gap-2 flex-wrap">
              <span className="text-xs text-muted-foreground w-full">Quick select:</span>
