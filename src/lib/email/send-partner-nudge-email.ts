...
<div style="max-width:600px;margin:0 auto;background:#fff;border-radius:8px;overflow:hidden;margin-top:24px;margin-bottom:24px;">
  ...
  <div style="padding:24px;">
    ...
    <div style="text-align:center;margin:32px 0 16px;">
      <a href="${baseUrl}/dashboard" style="display:inline-block;background:#0071E3;color:#fff;padding:12px 32px;border-radius:6px;text-decoration:none;font-weight:600;font-size:14px;">
        Open Dashboard
      </a>
    </div>
  </div>
