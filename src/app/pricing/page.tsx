    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="py-16 md:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Trust Indicators */}
          <div className="flex flex-wrap items-center justify-center gap-8 mb-20 py-8 border-y border-border">
          ...
          {/* Contact CTA */}
          <div className="text-center py-12 px-8 rounded-2xl bg-muted/50 border border-border">
