...
export default function MultipleAdjustmentPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Multiple Adjustment Formula</h1>
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="p-4 bg-gray-50 rounded-lg border">
            <h3 className="font-semibold text-gray-900 mb-2">Step 1: Base Multiple (Core Score Positioning)</h3>
            <div className="font-mono text-lg bg-white p-3 rounded border text-center">
          ...
          {/* Step 2 */}
          <div className="p-4 bg-gray-50 rounded-lg border">
            <h3 className="font-semibold text-gray-900 mb-2">Step 2: Discount Fraction (BRI Impact)</h3>
            <div className="font-mono text-lg bg-white p-3 rounded border text-center">
          ...
          {/* Step 3 */}
          <div className="p-4 bg-gray-50 rounded-lg border">
            <h3 className="font-semibold text-gray-900 mb-2">Step 3: Final Multiple (Floor Guarantee)</h3>
            <div className="font-mono text-lg bg-white p-3 rounded border text-center">
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y">
                <tr>
                  ...
                  <td className="py-2 px-3 text-gray-600">Floor multiple for the industry classification</td>
                </tr>
                <tr>
                  <td className="py-2 px-3 font-mono font-semibold">H</td>
                  <td className="py-2 px-3">Industry Multiple High</td>
                  <td className="py-2 px-3">Varies by industry</td>
                  <td className="py-2 px-3 text-gray-600">Ceiling multiple for the industry classification</td>
                </tr>
                <tr>
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="space-y-4">
              {/* Input Variables */}
              <div>
                <h4 className="font-semibold text-gray-900 mb-2">Input Variables</h4>
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                  <div className="p-3 bg-gray-50 rounded-lg text-center">
                    <p className="text-xs text-gray-500 font-medium">L (Low)</p>
                    <p className="text-xl font-semibold">{snapshot.industryMultipleLow.toFixed(1)}x</p>
                  </div>
                  <div className="p-3 bg-gray-50 rounded-lg text-center">
                    <p className="text-xs text-gray-500 font-medium">H (High)</p>
                    <p className="text-xl font-semibold">{snapshot.industryMultipleHigh.toFixed(1)}x</p>
                  </div>
                  <div className="p-3 bg-gray-50 rounded-lg text-center">
                    <p className="text-xs text-gray-500 font-medium">CS (Core Score)</p>
                    <p className="text-xl font-semibold">{Math.round(snapshot.coreScore * 100)}</p>
                  </div>
                  <div className="p-3 bg-gray-50 rounded-lg text-center">
                    <p className="text-xs text-gray-500 font-medium">BRI</p>
                    <p className="text-xl font-semibold">{Math.round(snapshot.briScore * 100)}</p>
                  </div>
                  <div className="p-3 bg-gray-50 rounded-lg text-center">
                    <p className="text-xs text-gray-500 font-medium">α (Alpha)</p>
              ...
              {/* Valuation Results */}
              <div>
                <h4 className="font-semibold text-gray-900 mb-2">Valuation Results</h4>
                <div className="grid grid-cols-3 gap-4">
                  <div className="p-3 bg-gray-50 rounded-lg text-center">
                    <p className="text-xs text-gray-500 font-medium">Adjusted EBITDA</p>
                  ...
                  <div className="p-3 bg-gray-50 rounded-lg text-center">
                    <p className="text-xs text-gray-500 font-medium">Potential Value</p>
            ...
            <p className="text-gray-500 text-center py-8">
              No company selected or no assessment completed yet.
            </p>
          )}
        </CardContent>
      </Card>
